...
*/
void BloqueNube::CargarTextura(const char* ruta)
{
	// Cargamos la imagen
...
*/
void BloqueNube::IniciarCuerpoFisico(b2World* world)
{
...
/*
Constructor de un bloque nube en una posicion dada. Necesita la camara y el mundo fisico actual
*/
BloqueNube::BloqueNube(float x, float y, Camara* camara, b2World* world)
{
	...
	// Cargamos la textura
	CargarTextura(RUTA_BLOQUE_NUBE);
