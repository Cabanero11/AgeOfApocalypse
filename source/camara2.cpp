...
*/
Camara2::Camara2(float x, float y)
{
	this->x = x;
	this->y = y;
}
...
*/
void Camara2::AsignarJugador2(Jugador2* jugador2)
{
...
void Camara2::Actualizar2()
{
	...
	*/
	x = jugador2->posicion.x - SCREEN_W / 2.0f + jugador2->posicion.w / 2.0f;
	y = jugador2->posicion.y - SCREEN_H / 2.0f - jugador2->posicion.h / 2.0f;
	if (x < 0) x = 0;
