...
/*
Metodo para iniciar las propiedades fisicas de la moneda
*/
...
/*
Constructor de una moneda de Yoshi en una posicion dada. Necesita la camara y el mundo fisico actual
*/
MonedaYoshi::MonedaYoshi(float x, float y, Camara* camara, b2World* world)
{
	...
	// Cargamos la textura y creamos la animacion
...
/*
Metodo a ejecutar cuando se ha recogido la moneda
*/
...
/*
Metodo para dibujar en pantalla la moneda
*/
void MonedaYoshi::Renderizar()
{
	// Si se ha recogido no la renderizamos
	if (recogida) return;
	
	// Actualizamos la animacion y la textura
