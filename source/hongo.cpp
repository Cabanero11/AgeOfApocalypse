...
/*
Metodo para iniciar las propiedades fisicas del hongo
*/
...
/*
Constructor de un hongo en una posicion dada. Necesita la camara y el mundo fisico actual
*/
...
/*
Metodo a ejecutar cuando se ha recogido el hongo
*/
void Hongo::Recoger()
{
	if (!recogido)
